...
class AddressEmbeddable extends Address
{
    ...
    public function setSortingCode(?string $sortingCode): static
    {
    ...
    public function setDependentLocality(?string $dependentLocality): static
    {
    ...
    public function setAdministrativeArea(?string $administrativeArea): static
    {
