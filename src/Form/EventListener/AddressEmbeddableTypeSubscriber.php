...
readonly class AddressEmbeddableTypeSubscriber implements EventSubscriberInterface
{
    ...
    public function preSetData(FormEvent $event): void
    {
        ...
        $autocompleteOff = (!isset($options['attr']['autocomplete']) || 'off' === $options['attr']['autocomplete']);
        $element_options = [];
    ...
    private function getFieldOverrides(FormInterface $form): FieldOverrides
    {
        ...
        try {
            $metadata = $this->validator->getMetadataFor($parentEntity::class);
